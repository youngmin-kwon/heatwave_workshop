...
### 1.3 머신 러닝 DataSet - Train Data & Test Data
...
### 1.4 머신 러닝 모델 학습 - Training Models
...
### 1.5 Predioction 및 Explanation

학습된 모델을 사용하여 새로운 데이터에 대해 예측값을 확인해 보겠습니다.  

**Row Predictions 및 Explanation**
...
위의 결과에서 각 feature 별 **_attribution** 값에서 설명 정보를 확인할 수 있습니다.

**Table Predictions 및 Explanation**

**ML_PREDICT_TABLE** 함수는 unlabeled data를 가지는 테이블 데이터 전체에 대해 Prediction을 수행하여
예측 결과를 output 테이블에 저장합니다.
